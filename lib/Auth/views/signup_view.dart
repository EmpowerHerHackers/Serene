import 'package:serene/food_layout/Core/Utils/utils.dart';
...
import 'package:serene/Auth/screens/account_status.dart';
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Gap(32),
              const AccountStatus(
                  action: " Sign In", question: "Don't have an account")
            ],
          ),
        ));
  }
